...
public class SearchArticleAdapter extends RecyclerView.Adapter<SearchArticleAdapter.ViewHolder> {
    ...
    public SearchArticleAdapter(Context context,ArrayList<NewsArticle> list){
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchArticleAdapter.ViewHolder holder, int position) {
